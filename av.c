...
/* TODO(leonerd): Consider if we want a 'flags' argument to let the caller
 * specify alternative behaviours for SV refcounting in either deleted or
 * inserted subsequences, magical behaviours, or other considerations.
 */
