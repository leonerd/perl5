...
# define sv_usertaint_applyto(a)                Perl_sv_usertaint_applyto(aTHX_ a)
# define sv_usertaint_from(a)                   Perl_sv_usertaint_from(aTHX_ a)
...
#   define sv_usertaint_clear()                 Perl_sv_usertaint_clear(aTHX)
