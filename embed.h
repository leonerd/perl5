...
# define viralmagic_applyto(a)                  Perl_viralmagic_applyto(aTHX_ a)
# define viralmagic_clear()                     Perl_viralmagic_clear(aTHX)
# define viralmagic_from(a)                     Perl_viralmagic_from(aTHX_ a)
...
#     define mg_disinfect_vstring(a)            S_mg_disinfect_vstring(aTHX_ a)
#     define mg_infect_also_vstring(a,b)        S_mg_infect_also_vstring(aTHX_ a,b)
